...
export function plainAnimation(){
    ...
    iconTL.to("#meter6",{scale: 1.5, transformOrigin:"50% 50%"}, "-=.5")
    iconTL.to("#meter6",{scale: 1})
    iconTL.to("#meter4",{scale: 1.5, transformOrigin:"50% 50%"}, "-=.5")
    iconTL.to("#meter4",{scale: 1})
    iconTL.to("#level2bar2-copy-24",{speed: 13, rotate: 180, transformOrigin:"50% 50%"} )
    iconTL.to("#meter3",{scale: 1.5, transformOrigin:"50% 50%"}, "+=1")
    iconTL.to("#meter3",{scale: 1})
    iconTL.to("#meter1",{scale: 1.5, transformOrigin:"50% 50%"}, "-=.5")
    iconTL.to("#meter1",{scale: 1})
    iconTL.to("#meter2",{scale: 1.5, transformOrigin:"50% 50%"}, "-=.5")
    iconTL.to("#meter2",{scale: 1}) 
    iconTL.to("#meter2",{x: -170})
    iconTL.to("#meter5",{x: 1050},"-=.5")
